<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="uyeKayit.aspx.cs" Inherits="eTicaret.uyeKayit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="float:left; width:143px; height:60px">
        ...
        <br /><br /><br />
        <asp:TextBox ID="txtSozlesme" TextMode="MultiLine" runat="server" Height="129px" Width="148px" ReadOnly="true" Text="Gizlilik Sözleşmesi : Girmiş olduğunuz kişisel bilgileriniz, 3.şahıs ve kurumlarla kesinlikle paylaşılmayacaktır. Her türlü özel bilgi ve ödeme işlemleriniz 128 bit SSL güvenşlik sertifikalarıyla şifrelenmektedir." BackColor="White" Font-Names="Verdana" Font-Size="8pt"></asp:TextBox>
    </div>
</asp:Content>