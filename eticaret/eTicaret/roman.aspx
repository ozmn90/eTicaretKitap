<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="roman.aspx.cs" Inherits="eTicaret.roman" %>
        ...
        <ItemTemplate>
            <div class="templatemo_product_box">
                ...
                <div class="product_info">
                    ...
                    <asp:TextBox ID="txtAdet" runat="server" TextMode="Number" Width="30px" Height="20" Text="1"></asp:TextBox>
                    <br />
                    <%--&nbsp --%>
